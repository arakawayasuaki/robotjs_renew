...
enum _MMKeyCode {
	...
	K_HIRAGANA = VK_OEM_COPY,
	K_KATAKANA = VK_OEM_COPY,
	K_NONCONVERT = VK_NONCONVERT,
	K_HANKAKU = VK_OEM_AUTO, 
	K_ZENKAKU = VK_OEM_AUTO,
	K_ROMAJI = VK_OEM_BACKTAB,
	K_KANAMODE = VK_OEM_BACKTAB,
	K_KANJIMODE = VK_KANJI,

	K_ALPHANUMERIC = VK_OEM_ATTN,
	K_AUDIO_REWIND = K_NOT_A_KEY,
	K_AUDIO_FORWARD = K_NOT_A_KEY,
	K_AUDIO_REPEAT = K_NOT_A_KEY,
	K_AUDIO_RANDOM = K_NOT_A_KEY,
